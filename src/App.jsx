...
function App() {
  ...
  return (
      ...
      <main>
        {showInvoice ? (
          ...
          <div className="max-w-6xl mx-auto bg-blue-400 p-8 rounded-2xl shadow-lg flex flex-col gap-6 ">
            {/* Section Title */}
            <h2 className="text-4xl font-bold text-white mb-2 text-center hover:bg-amber-950 hover:text-emerald-600 uppercase underline ">
            ...
            <div className="flex flex-col">
              <label
                htmlFor="name"
                className="font-semibold mb-1  text-white  text-2xl "
              >
                Enter your name
              </label>
              <input
            ...
            {/* Bank Info */}
            <h3 className="font-bold  mt-4   text-2xl underline   text-amber-300">
              Bank Details
            </h3>
            <label className="font-semibold  text-white mb-1 text-2xl">
              Accoun Number
            ...
            {/* Client Info */}
            <h3 className="text-2xl font-bold  mt-4 underline  text-amber-300">
              Client Details
            </h3>
            <label className="font-semibold  text-white mb-1 text-2xl">
              Cleint Name
            ...
            <div className="flex grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <label className="font-semibold  text-white mb-1 text-2xl flex text-center ">
                Invoice Date
              </label>
              <input
                type="date"
    ...
    /> */}
            ...
            <label className="text-2xl underline  text-amber-300">
              Additional Notes
            </label>
            <textarea
